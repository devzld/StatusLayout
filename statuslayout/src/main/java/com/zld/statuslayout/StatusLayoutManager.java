...
public class StatusLayoutManager {
    ...
    public StatusLayoutManager(Builder builder) {
        ...
        parentView.addView(rootFrameLayout);
    }
    ...
    public static final class Builder {
        ...
        private View contentLayoutResId;
    ...
    public static Builder newBuilder(Context context,ViewGroup parentView) {
        return new Builder(context,parentView);
    }
