...
public class RootFrameLayout extends FrameLayout {
    ...
    private void addAllLayoutToRootLayout() {
        if (mStatusLayoutManager.contentLayoutResId != null) addLayoutResId(mStatusLayoutManager.contentLayoutResId, RootFrameLayout.LAYOUT_CONTENT_ID);
    ...
    private void addLayoutResId(View resView, int id) {
        layoutSparseArray.put(id, resView);
        addView(resView);
    }
